	...
	return (
		<CheckpointControls onMouseLeave={handleControlsMouseLeave}>
			<VSCodeButton
				...
				title={t("checkpointControls.compare")}>
			...
			<div ref={containerRef} style={{ position: "relative" }}>
				<VSCodeButton
					...
					title={t("checkpointControls.restore")}>
					...
					<RestoreConfirmTooltip onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} ref={tooltipRef}>
						<RestoreOption>
							<VSCodeButton
								...
								{t("checkpointControls.restoreTaskAndWorkspace")}
							</VSCodeButton>
							<p>{t("checkpointControls.restoreTaskAndWorkspaceDescription")}</p>
						</RestoreOption>
						<RestoreOption>
							<VSCodeButton
							...
							<p>{t("checkpointControls.restoreTaskOnlyDescription")}</p>
						</RestoreOption>
						<RestoreOption>
							<VSCodeButton
								...
								{t("checkpointControls.restoreWorkspaceOnly")}
							</VSCodeButton>
							<p>{t("checkpointControls.restoreWorkspaceOnlyDescription")}</p>
						</RestoreOption>
