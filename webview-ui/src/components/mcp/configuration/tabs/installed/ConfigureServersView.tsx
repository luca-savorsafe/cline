	...
	return (
		<div style={{ padding: "16px 20px" }}>
			<div
				...
				{t("mcp.configureServers.description", {
					modelContextProtocol: (
						<VSCodeLink href="https://github.com/modelcontextprotocol" style={{ display: "inline" }}>
							{t("mcp.configureServers.modelContextProtocol")}
						</VSCodeLink>
					),
					communityMadeServers: (
						<VSCodeLink href="https://github.com/modelcontextprotocol/servers" style={{ display: "inline" }}>
							{t("mcp.configureServers.communityMadeServers")}
						</VSCodeLink>
					),
					seeDemoHere: (
						<VSCodeLink href="https://x.com/sdrzn/status/1867271665086074969" style={{ display: "inline" }}>
							{t("mcp.configureServers.seeDemoHere")}
						</VSCodeLink>
					),
				})}
			</div>
			...
			{hasRemoteMCPServers && (
				<div className="flex items-center gap-2 px-5 py-3 mb-4 bg-vscode-textBlockQuote-background border-l-[3px] border-vscode-textLink-foreground">
					...
					<span className="text-base">{t("mcp.configureServers.organizationManagesServers")}</span>
				</div>
			)}
			...
			<div style={{ marginBottom: "20px", marginTop: 10 }}>
				...
				<div style={{ textAlign: "center" }}>
					<VSCodeLink onClick={() => navigateToSettings("features")} style={{ fontSize: "12px" }}>
						{t("mcp.configureServers.advancedMcpSettings")}
					</VSCodeLink>
				</div>
			</div>
		</div>
