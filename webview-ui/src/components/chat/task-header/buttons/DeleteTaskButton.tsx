...
const DeleteTaskButton: React.FC<{
	...
	const formattedSize = taskSize ? formatSize(taskSize) : "--"
	const tooltipText = t("taskHeader.deleteTaskButton.tooltip", { size: formattedSize })
	const ariaLabel = t("taskHeader.deleteTaskButton.ariaLabel")
