				...
				<div className="mb-5" id="terminal-settings-section">
					<div className="mb-4">
						<label className="font-medium block mb-1" htmlFor="default-terminal-profile">
							{t("terminal.settings.defaultTerminalProfile")}
						</label>
						<VSCodeDropdown
							className="w-full"
						...
						<p className="text-xs text-(--vscode-descriptionForeground) mt-1">
							{t("terminal.settings.defaultTerminalProfileDescription")}
						</p>
					</div>

					<div className="mb-4">
						<div className="mb-2">
							<label className="font-medium block mb-1">{t("terminal.settings.shellIntegrationTimeout")}</label>
							<div className="flex items-center">
								<VSCodeTextField
									className="w-full"
									onBlur={handleInputBlur}
									onChange={(event) => handleTimeoutChange(event as Event)}
									placeholder={t("terminal.settings.shellIntegrationTimeoutPlaceholder")}
									value={inputValue}
								/>
							</div>
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							{t("terminal.settings.shellIntegrationTimeoutDescription")}
						</p>
					</div>
					...
					<div className="mb-4">
						<div className="flex items-center mb-2">
							<VSCodeCheckbox
								...
								{t("terminal.settings.enableAggressiveTerminalReuse")}
							</VSCodeCheckbox>
						</div>
						<p className="text-xs text-(--vscode-descriptionForeground)">
							{t("terminal.settings.aggressiveTerminalReuseDescription")}
						</p>
					</div>
					{isVsCodePlatform && (
						<div className="mb-4">
							<label className="font-medium block mb-1" htmlFor="terminal-execution-mode">
								{t("terminal.settings.terminalExecutionMode")}
							</label>
							<VSCodeDropdown
								className="w-full"
								...
								<VSCodeOption value="vscodeTerminal">{t("terminal.settings.vscodeTerminal")}</VSCodeOption>
								<VSCodeOption value="backgroundExec">{t("terminal.settings.backgroundExec")}</VSCodeOption>
							</VSCodeDropdown>
							<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
								{t("terminal.settings.terminalExecutionModeDescription")}
							</p>
						</div>
					)}
					...
					<div className="mt-5 p-3 bg-(--vscode-textBlockQuote-background) rounded border border-(--vscode-textBlockQuote-border)">
						<p className="text-[13px] m-0">
							<strong>{t("terminal.settings.havingTerminalIssues")}</strong> Check our{" "}
							<a
								...
								target="_blank">
								{t("terminal.settings.terminalQuickFixes")}
							</a>{" "}
							or the{" "}
							<a
								className="text-(--vscode-textLink-foreground) underline hover:no-underline"
								...
								rel="noopener noreferrer"
								target="_blank">
								{t("terminal.settings.completeTroubleshootingGuide")}
							</a>
							.
						</p>
					</div>
